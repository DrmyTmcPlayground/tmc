...
const struct_gUnk_080B3D20 gUnk_080B3D20[] = {
    { LOCAL_BANK_0, HAVE_EZLO, 0, 0 },
    { LOCAL_BANK_0, SEEN_TREE_TRUNK_MINISH_CUTSCENE, 0, 1 },
    ...
    { LOCAL_BANK_0, THREW_BEAN_TO_HOLE, 1, 5 },
    ...
    { LOCAL_BANK_0, VISITED_CASTOR_WILDS_READ_SIGN, 2, 4 },
    ...
    { LOCAL_BANK_0, HYRULE_TOWN_LIBRARY_SPOKE_TO_LIBRARY_RECEPTIONIST, 3, 2 },
