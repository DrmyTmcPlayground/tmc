...
static const SaveFile gDemoSave = {
    ...
    .flags = {
        [FLAG_BYTE(FLAG_BANK_G, START)] = FLAG_X(START) | FLAG_X(HAVE_EZLO) | FLAG_X(SAW_DALTUS_AND_SMITH_SCENE),
        [FLAG_BYTE(FLAG_BANK_G, EXITED_LINKS_HOUSE)] = FLAG_X(EXITED_LINKS_HOUSE),
        [FLAG_BYTE(FLAG_BANK_G, SEEN_TREE_TRUNK_MINISH_CUTSCENE)] = FLAG_X(SEEN_TREE_TRUNK_MINISH_CUTSCENE),
        ...
        [FLAG_BYTE(FLAG_BANK_5, MAP_SCREEN_VISITED_ENTRANCE_DEEPWOOD_SHRINE_1_ENTRANCE)] = FLAG_X(MAP_SCREEN_VISITED_ENTRANCE_DEEPWOOD_SHRINE_1_ENTRANCE),
    },
};
